...
class Halofit(NonLinearModel):
    ...
    _fields_ = [
        ...
        ("HMCode_DETG_beta", c_double, "HMcode parameter DETG_beta"),
        ("HMCode_DETG_p", c_double, "HMcode parameter DETG_p")
    ]
    ...
    def set_params(self, halofit_version=halofit_default, HMCode_A_baryon=3.13, HMCode_eta_baryon=0.603,
                   HMCode_logT_AGN=7.8, HMCode_DETG_beta=0.0, HMCode_DETG_p=0.0):
        """
        ...
        self.HMCode_DETG_beta = HMCode_DETG_beta
        self.HMCode_DETG_p = HMCode_DETG_p
